...
#      ```
#      $ docker build -f webapp-node16.Dockerfile -t nmdc-edge-web-app:some-tag .
#      ```
...
#      ```
#      $ docker buildx build --platform linux/amd64 -f webapp-node16.Dockerfile -t nmdc-edge-web-app:some-tag .
#      ```
