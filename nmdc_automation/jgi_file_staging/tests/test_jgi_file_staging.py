...
class JgiFileTestCase(unittest.TestCase):
    ...
    def test_get_sample_files(self, mock_token, mock_get, mock_get_files_list):
        ...
        grow_samples = get_sample_files(
            os.path.join(self.fixtures, "grow_samples.txt"), "ed42ef155670"
        )
        self.assertEqual(
    ...
    def test_get_globus_manifests(self, mock_run):
        ...
        self.assertEqual(
            ...
            ["globus", "ls", "65fa2422-e080-11ec-990f-3b4cfda38030:/73709/"],
        )
    ...
    def test_create_globus_df(self):
        ...
        self.assertEqual(
            globus_df.loc[0, "directory/path"],
            "ERLowmetatpilot/Sequencing_QC_Reports/Krona_output",
        )
        ...
        self.assertEqual(
            globus_df.loc[72, "md5 checksum"], "d8457dc907aed0ffe086a99bbbe44512"
        )
    ...
    def test_create_globus_batch_file(self):
        ...
        try:
            ...
            self.assertEqual(
                globus_batch_filename, "test_project_globus_batch_file.txt"
            )
            ...
            os.remove("test_project_globus_batch_file.txt") if os.path.exists(
                "test_project_globus_batch_file.txt"
            ) else None
