...
logging.basicConfig(filename='downloads.log',
...
def download_files(project, config_file, csv_file):
    ...
    base_dir = os.path.join(config['GLOBUS']['dest_root_dir'], f'{project}_analysis_projects')
...
if __name__ == '__main__':
    ...
    parser.add_argument('sample_csv_file', help='save list of staged files to output file')
