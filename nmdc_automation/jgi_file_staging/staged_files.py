...
def get_list_missing_staged_files(project_name, config_file, save_file_list=None) -> list:
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--save_file_list', action='store_true', help='save list of staged files to output file',
                        default=False)
    args = vars((parser.parse_args()))
    get_list_missing_staged_files(args['project_name'], args['config_file'], args['save_file_list'])
