...
class GoldMapper():
    ...
    def attach_objects_to_activity(self, activity_type:str) -> Tuple[List[str], List[str]]:
        ...
        Returns:
            Tuple[List[str], List[str]]: Two lists containing the data object ids of the data objects that are 
                inputs to and outputs of the specified activity type.
        """
    ...
    def post_nmdc_database_object(self) -> Dict:
        ...
        This function dumps the NMDC database object into JSON format, then posts it 
