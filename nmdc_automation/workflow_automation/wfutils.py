...
class WorkflowJob():
    ...
    def __init__(self, site_config, typ=None, workflow_config=None,
                 nmdc_jobid=None, opid=None, activity_id=None,
                 state=None, nocheck=False):
    ...
    def get_label_parameters(self):
        return {param: self.workflow_config[param]
...
class NmdcSchema():
    ...
    def make_data_object(self, name: str, full_file_name: str,
                         file_url: str, data_object_type: str,
                         dobj_id: str, md5_sum: str,
                         description: str, omics_id: str) -> None:
    ...
    def create_activity_record(self, activity_record, activity_name,
                               workflow, activity_id, resource,
                               has_inputs_list, has_output_list,
                               omic_id, start_time, end_time):
    ...
    def activity_map(self):
        ...
        activity_store_dict = {
            'nmdc:MetagenomeSequencing': (self.nmdc_db.metagenome_sequencing_activity_set,
                                          nmdc.MetagenomeSequencingActivity),
            'nmdc:ReadQcAnalysisActivity': (self.nmdc_db.read_qc_analysis_activity_set,
                                            nmdc.ReadQcAnalysisActivity),
            'nmdc:ReadBasedTaxonomyAnalysisActivity': (self.nmdc_db.read_based_taxonomy_analysis_activity_set,
                                                       nmdc.ReadBasedTaxonomyAnalysisActivity),
            'nmdc:MetagenomeAssembly': (self.nmdc_db.metagenome_assembly_set,
