...
function Admin(props) {
    ...
    useEffect(() => {
        ...
        if (parsed.code) {
            ...
            props.history.push("/admin/bulksubmissionlist");
        }
    }, [user, props]);

    useEffect(() => {
        function getBulkSubmissionInfo() {
            let url = "/auth-api/admin/bulkSubmission/info";
            const projData = {
                code: code,
            };
        ...
        <div className="animated fadeIn">
            ...
            {error ?
                ...
                <>
                    ...
                    <br></br>
                    <BulkSubmissionResult bulkSubmission={bulkSubmission} type={'admin'} {...props} />
                </>
            }
        </div>
    );
