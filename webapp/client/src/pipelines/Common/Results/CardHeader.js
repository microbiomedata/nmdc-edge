...
export function Header(props) {
    ...
    return (
        <CardHeader style={{ backgroundColor: headerColor, cursor: 'pointer' }} onMouseEnter={(e) => setHeaderColor(colors.secondary)}
            onMouseLeave={() => setHeaderColor(colors.light)} onClick={props.toggleParms}>
            {props.toggle ?
                <>
