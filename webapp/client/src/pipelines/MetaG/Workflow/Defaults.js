...
export const workflowInputTips = {
    ...
    MetaMAGs: {
        ...
        cath_funfam_file: 'The &lt;prefix&gt;_cath_funfam.gff of the Metagenome Annotation workflow output<br />Note: The file size limit for the URL input is 10GB',
        smart_file: 'The &lt;prefix&gt;_smart.gff of the Metagenome Annotation workflow output<br />Note: The file size limit for the URL input is 10GB',
        supfam_file: 'The &lt;prefix&gt;supfam.gff of the Metagenome Annotation workflow output<br />Note: The file size limit for the URL input is 10GB',
        ...
        map_file: 'Note: The file size limit for the URL input is 10GB',
        domain_file: 'Note: The file size limit for the URL input is 10GB',
    },
}
...
export const initialMetaMAGs = {
    ...
    cath_funfam_file_validInput: false,
    smart_file_validInput: false,
    supfam_file_validInput: false,
    ...
    cath_funfam_file_autoFill: false,
    smart_file_autoFill: false,
    supfam_file_autoFill: false,
