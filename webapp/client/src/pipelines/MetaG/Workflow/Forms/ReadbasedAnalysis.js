        ...
        <Card className="workflow-card">
            ...
            <Collapse isOpen={!collapseParms} id={"collapseParameters-" + props.name} >
                <CardBody>
                    ...
                    <FastqInput projectTypes={['ReadsQC','Retrieve SRA Data']} singleType={'single-end'} name={props.name} full_name={props.full_name} setParams={updateFastqInputs} collapseParms={true} paired-input-max={form['paired-input-max']} />
                </CardBody>
            </Collapse>
        </Card >
    );
