        ...
        user.isAuthenticated ? (
          <div style={{ backgroundColor: 'white', height: '60px' }}>
            ...
            <div className="submenu" >
              ...
              <CHeaderNavLink className="btn btn-pill btn-ghost-primary" to="/user/bulksubmissionlist">My Bulk Submissions</CHeaderNavLink>
              ...
              {user.profile.type === 'admin' && <>
                ...
                <CHeaderNavLink className="nmdc-header-no-min btn btn-pill btn-ghost-danger" to="/admin/bulksubmissionlist">Admin Bulk Submissions</CHeaderNavLink>
