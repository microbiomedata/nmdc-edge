...
workflow main_workflow {
	...
	call finish {
		input: 
			...
			filtered = jgi_rqcfilter_call.filtered_final,
			filtered_stats = jgi_rqcfilter_call.filtered_stats_final,
			filtered_stats2 = jgi_rqcfilter_call.filtered_stats2_final,
			filtered_stats_json = jgi_rqcfilter_call.filtered_stats_json_final,
