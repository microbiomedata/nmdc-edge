	...
	String proj
 	...
 	command<<<
			...
			do
                ...
                cp $dir/*_filterStats.txt ${outdir}/$prefix/filterStats.txt
				cp $dir/*_filterStats2.txt ${outdir}/$prefix/filterStats2.txt
				cp $dir/*_filterStats.json ${outdir}/$prefix/filterStats.json
				cp $i ${outdir}/$prefix/
